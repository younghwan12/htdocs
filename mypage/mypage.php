<?php
    ...
    $phoneSql = "SELECT SUBSTR(youPhone, 5, 4) FROM myMember WHERE memberID = {$memberID}";
    $phResult = $connect -> query($phoneSql);
    $phInfo = $phResult -> fetch_array(MYSQLI_ASSOC);
                ...
                <div class="join__info">
                    ...
                    <div class="info">
                        <ul>
                            ...
                            <li>
                                <strong>연락처</strong>
                                <span>010-<?=$phInfo['SUBSTR(youPhone, 5, 4)']?>-****</span>
                            </li>
                        </ul>
                    </div>
                    <div class="btn">
